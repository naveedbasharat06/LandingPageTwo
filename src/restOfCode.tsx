  ...
  return (
    ...
    >
      ...
      <button
        ...
        className=" z-10 p-3 w-12 rounded-full bg-gray-300 dark:bg-gray-700 text-black dark:text-white  shadow-lg absolute right-5 md:right-2 lg:right-5  top-20 md:top-5 transition delay-150 duration-300 ease-in-out hover:-translate-y hover:scale-110"
